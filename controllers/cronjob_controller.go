...
func (r *CronJobReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	getScheeduledTimeForJob := func(job *kbatch.Job) (*time.Time, error) {
	...
	for i, job := range childJobs.Items {
		...
		scheduledTimeForJob, err := getScheeduledTimeForJob(&job)
		if err != nil {
	...
	//清理掉一些版本太旧的 job，这样可以不用保留太多无用的 job
